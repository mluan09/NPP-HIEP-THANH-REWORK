    ...
    <div className={`relative w-full ${className}`}>
      ...
      {value && (
        <button
          ...
          onClick={() => onChange('')}
          className="absolute right-1 top-1/2 -translate-y-1/2 touch-target rounded-lg text-slate-400 hover:bg-slate-800 hover:text-slate-200 transition-colors cursor-pointer"
        >
          <X className="w-4 h-4" />
        </button>
      )}
